...
def process_command(text):
    ...
    for cmd in commands:
        ...
        if "open browser" in cmd or "launch browser" in cmd:
            responses.append('<a href="https://www.google.com" target="_blank">Click here to open Google</a>')
            continue

        if "open youtube" in cmd or "launch youtube" in cmd:
            responses.append('<a href="https://www.youtube.com" target="_blank">Click here to open YouTube</a>')
            continue
